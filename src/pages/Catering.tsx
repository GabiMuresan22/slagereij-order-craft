...
export default function Catering() {
  ...
  const galleryImages = [
    ...
    { src: cateringBuffetSpread, alt: "Colorful buffet spread with fresh salads, donuts display, and party foods" },
    { src: cateringPastaBowls, alt: "Artisanal pasta salad bowls with fresh vegetables in decorative serving dishes" },
  ];
