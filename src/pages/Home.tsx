...
const Home = () => {
  ...
  const handleDownloadFolder = async () => {
    ...
    try {
      ...
      toast.error(
        language === "nl" ? "Fout bij downloaden. Probeer opnieuw." : "Eroare la descărcare. Încercați din nou.",
      );
    } finally {
    ...
    <div className="min-h-screen pb-[60px] lg:pb-0">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <LocalizedLink to="/order" className="hidden lg:block">
              <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {language === "nl" ? "Vlees van lokale boeren" : "Carne de la fermieri locali"}
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {language === "nl" ? "Dagelijks vers bereid" : "Preparat proaspăt zilnic"}
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {language === "nl" ? "Bestel online, haal op" : "Comandă online, ridică"}
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">{t("home.catering.body")}</p>
            ...
            <div className="order-1 md:order-2">
              <div className="aspect-[4/3] rounded-xl overflow-hidden shadow-xl">
                <img
                  ...
                  alt={
                    language === "nl"
                      ? "Complete party catering met tacos en bijgerechten"
                      : "Catering complet pentru petreceri"
                  }
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">{t("home.about.p1")}</p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">{t("home.about.p2")}</p>
      ...
      <section className="py-16 md:py-20 bg-primary text-primary-foreground" aria-labelledby="cta-heading">
        <div className="container mx-auto px-4 text-center">
          <h2 id="cta-heading" className="text-3xl md:text-5xl font-serif font-bold mb-4">
            {t("home.cta.title")}
          </h2>
